...
欢迎登录图书管理系统!!</h2>
<form action="${pageContext.request.contextPath}/stu/validate.action" method="post">
...
<input type="reset" value="重置" style="margin-top:5px;" />
    <p class="text-muted text-center"> <a href="login.html#"><small>忘记密码了？</small></a> | <a href="${pageContext.request.contextPath }/stu/register.action">注册一个新账号</a>
